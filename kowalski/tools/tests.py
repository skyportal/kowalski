    ...
    tests = [
        {
            ...
            "location": "broker/components/test_alert_broker_turbo.py",
            "flaky": False,
        },
        {
            "part": "PGIR alert broker components",
            "container": "kowalski_ingester_1",
            "location": "broker/components/test_alert_broker_pgir.py",
            "flaky": False,
        },
        {
            "part": "WINTER alert broker components",
            "container": "kowalski_ingester_1",
            "location": "broker/components/test_alert_broker_wntr.py",
            "flaky": False,
        },
        {
            "part": "ZTF alert broker components",
            "container": "kowalski_ingester_1",
            "location": "broker/components/test_alert_broker_ztf.py",
            "flaky": False,
        },
        {
            "part": "TURBO alert ingestion",
            "container": "kowalski_ingester_1",
            "location": "broker/ingestion/test_ingester_turbo.py",
            "flaky": False,
        },
        {
            "part": "PGIR alert ingestion",
            "container": "kowalski_ingester_1",
            "location": "broker/ingestion/test_ingester_pgir.py",
            "flaky": False,
        },
        {
            "part": "WINTER alert ingestion",
            "container": "kowalski_ingester_1",
            "location": "broker/ingestion/test_ingester_wntr.py",
            "flaky": False,
        },
        {
            "part": "ZTF alert ingestion",
            "container": "kowalski_ingester_1",
            "location": "broker/ingestion/test_ingester_ztf.py",
            "flaky": False,
        },
        {
            "part": "API",
